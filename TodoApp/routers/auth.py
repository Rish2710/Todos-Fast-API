...
SECRET_KEY = '8e88307ff4d19215ba43e603720d32d52f6e01fd006655895e2a'
ALGORITHM = 'HS256'
...
async def create_user(db : db_dependency,creat_user_request: CreateUserRequest):
    create_user_model = Users(
        ...
        hashed_password = bcrypt_context.hash(creat_user_request.password),
        is_active = True,
